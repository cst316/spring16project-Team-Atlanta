...
public class WorkPanel extends JPanel {
	...
	public ContactsPanel contactsPanel = new ContactsPanel();
	...
	void jbInit() throws Exception {
		...
		//Processes Button TMM 1/31/2016
		...
		processesB.setText(Local.getString("Process"));
