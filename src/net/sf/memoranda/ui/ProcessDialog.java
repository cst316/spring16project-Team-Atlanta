...
public class ProcessDialog extends JDialog {
	...
	this.setSize(new Dimension(430,300));
        ...
        Local.getString("Process Name"), TitledBorder.LEFT, TitledBorder.BELOW_TOP);
        ...
        header.setIcon(new ImageIcon(net.sf.memoranda.ui.ProcessDialog.class.getResource(
        ...
        jLabelDescription.setText(Local.getString("Process Description"));
